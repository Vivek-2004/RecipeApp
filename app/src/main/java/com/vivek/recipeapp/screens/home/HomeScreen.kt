            ...
            LazyColumn {
                ...
                item {
                    LazyRow(
                        ...
                        if (homeViewModel.state.popularRecipes.isEmpty()) {
                            items(3) { index ->
                                Box(
                                    modifier = Modifier
                                        .fillMaxSize()
                ...
                // Debug: Check all recipes count
                item {
                    Text(
                        text = "Debug: All recipes count: ${homeViewModel.state.allRecipes.size}",
                        fontSize = 12.sp,
                        color = Color.Red,
